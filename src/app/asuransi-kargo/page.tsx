...
export const metadata: Metadata = {
  ...
  description: "Praktisi asuransi kargo independen di Bekasi. Kargo darat untuk ekspedisi lokal dan Marine Cargo untuk impor-ekspor via laut/udara. Konsultasi gratis.",
